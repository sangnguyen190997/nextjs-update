...
export default function Navbar({ pos }) {
  ...
  return (
    <div
      ...
      } z-50  w-full h-24  text-white flex justify-around ${pos} top-0 left-0`}
    >
      ...
      <div className=" h-full flex item-center  justify-center px-4">
        <ul className="w-full h-full flex items-center justify-center">
          ...
          <li className="mx-4 p-2  text-lg cursor-pointer transition-all duration-500 hover:text-orange-600">
            About
          </li>
          <li className="mx-4 p-2  text-lg cursor-pointer transition-all duration-500 hover:text-orange-600">
            Contact
